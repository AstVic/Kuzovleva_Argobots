...
echo "scheduler,xstreams,size1,chunks1,size2,chunks2,size3,chunks3,size4,chunks4,task_count,total_time_seconds,total_real_time_nanos,total_steal_operations,total_stolen_tasks,verification" > "$SUMMARY"
...
for scheduler in old new; do
    ...
    for xstreams in "${XSTREAMS[@]}"; do
        ...
        echo "$scheduler,$xstreams,${TASK_SIZES[0]},${TASK_CHUNKS[0]},${TASK_SIZES[1]},${TASK_CHUNKS[1]},${TASK_SIZES[2]},${TASK_CHUNKS[2]},${TASK_SIZES[3]},${TASK_CHUNKS[3]},4,$total_time,$total_nanos,$total_steal_ops,$total_stolen_tasks,$verification" >> "$SUMMARY"
